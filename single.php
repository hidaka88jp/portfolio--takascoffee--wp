      ...
      <article class="blog-contents">
        ...
        <nav class="blog-contents__navigation">
          <div class="blog-contents__navigation-prev">
            <?php previous_post_link('%link', '<span class="blog-contents__navigation-icon" aria-hidden="true">&lt;</span><span class="blog-contents__navigation-text">Previous</span>'); ?>
          </div>
          <a href="<?php echo esc_url($url); ?>" class="link-button">
            Back to List
          </a>
          <div class="blog-contents__navigation-next">
            <?php next_post_link('%link', '<span class="blog-contents__navigation-text">Next</span><span class="blog-contents__navigation-icon" aria-hidden="true">&gt;</span>'); ?>
          </div>
        </nav>
      </article>
    <?php endwhile; ?>
